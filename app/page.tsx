...
/* =========================================================
   PRICING
   Change these numbers when LinearEra pricing is finalized.
========================================================= */
...
const ISSUES = [
  {
    name: "Too loose",
    icon: "↔",
    description: "It needs taking in",
  },
  {
    name: "Too tight",
    icon: "⇆",
    description: "It needs letting out",
  },
  {
    name: "Too long",
    icon: "↕",
  ...
  },
  {
    name: "Too short",
    icon: "↕",
    description: "Add / adjust length",
  },
  {
    name: "Sleeves",
    icon: "⌁",
    description: "Sleeve fit or length",
  },
  {
    name: "Waist",
    icon: "◌",
    description: "Waist needs adjusting",
  },
  {
    name: "Not sure",
    icon: "?",
    description: "Let our consultant assess",
  },
];
...
export default function LinearEraBooking() {
  ...
  function goToDetails() {
    const incomplete = garments.find(
      (garment) => !garment.issue
    );
      ...
      <main className="min-h-screen bg-[#f4f0e8] text-[#171713]">
        <div className="mx-auto flex min-h-screen max-w-3xl items-center justify-center px-5 py-16">
          <div className="w-full text-center">
            ...
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-[#171713] text-3xl text-[#f4f0e8]">
              ✓
            </div>

            <p className="mt-10 text-[10px] font-semibold uppercase tracking-[0.35em] text-[#9b8a70]">
              LinearEra
            </p>

            <h1 className="mt-5 font-serif text-5xl leading-[0.95] tracking-[-0.05em] sm:text-7xl">
              Your fit journey
              <br />
              starts here.
            </h1>

            <p className="mx-auto mt-7 max-w-lg text-sm leading-7 text-[#777064] sm:text-base">
              Thanks {name || "there"}.
              We’ll contact you on{" "}
              {phone || "your number"} to
              confirm your Fit Visit.
            </p>

            <div className="mx-auto mt-10 max-w-lg overflow-hidden rounded-[28px] border border-black/10 bg-white/50 text-left">
              <div className="p-6 sm:p-8">
                ...
                <p className="text-xs leading-5 text-[#8c8478]">
                  Final pricing is confirmed after
                  our Fit Consultant assesses the
                  garments.
                </p>
              </div>
            </div>
            ...
            <button
              ...
              className="mt-8 rounded-full bg-[#171713] px-8 py-4 text-sm font-medium text-white transition hover:opacity-90"
            >
              Back to LinearEra
            </button>
          </div>
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#f4f0e8] text-[#171713]">
      ...
      <header className="sticky top-0 z-50 border-b border-black/10 bg-[#f4f0e8]/95 backdrop-blur-xl">
        ...
        <div className="mx-auto flex h-[76px] max-w-[1500px] items-center justify-between px-5 sm:px-8 lg:px-12">
          ...
          <div>
            ...
            <div className="font-serif text-2xl tracking-[-0.05em] sm:text-3xl">
              LinearEra
            </div>
      ...
      <div className="hidden border-b border-black/10 bg-[#eee8dc] lg:block">
        ...
        <div className="mx-auto flex max-w-[1500px] items-center justify-center gap-10 px-12 py-5 xl:gap-20">
          ...
          {step === 1 && (
            <>
              ...
              <div className="max-w-3xl">
                ...
                <h1 className="max-w-2xl font-serif text-5xl leading-[0.92] tracking-[-0.055em] sm:text-6xl lg:text-7xl xl:text-8xl">
                  What are we
                  <br />
                  fixing?
                </h1>
                ...
                <p className="mt-6 max-w-md text-sm leading-6 text-[#777064] sm:text-base">
                  Select everything you’d
                  like altered during this
                  visit.
                </p>

                {/* ORDER TYPE */}

                <div className="mt-8 inline-flex max-w-full rounded-full border border-black/10 bg-white p-1">
                ...
                {orderType ===
                  "Family / Friends" && (
                  <div className="mt-4 max-w-md rounded-2xl bg-[#e9e2d6] px-5 py-4">
                    <p className="text-xs font-medium">
                      One visit. Multiple wardrobes.
                    </p>

                    <p className="mt-1 text-[11px] leading-5 text-[#777064]">
                      Add everyone's garments
                      to the same doorstep visit
              ...
              <div className="mt-12 grid grid-cols-2 gap-3 sm:gap-5 md:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4">
                  ...
                  (garment) => {
                    ...
                    return (
                      <button
                        ...
                        className="group relative overflow-hidden rounded-[22px] border border-black/10 bg-white text-left transition duration-300 hover:-translate-y-1 hover:shadow-2xl sm:rounded-[28px]"
                      >
                        ...
                        <div className="relative aspect-[0.82] overflow-hidden">
                          ...
                          <div className="absolute bottom-4 left-4 right-4 text-white">
                            ...
                            <div className="font-serif text-xl leading-none sm:text-2xl">
                              {
                                garment.type
                              }
                            </div>

                            <div className="mt-2 text-[9px] uppercase tracking-[0.15em] opacity-80">
                              {
                                garment.description
                              }
                            </div>
                        ...
                        <div className="flex items-center justify-between px-4 py-4 sm:px-5">
                          ...
                          <span className="flex h-9 w-9 items-center justify-center rounded-full bg-[#f1ece2] text-lg transition group-hover:bg-[#171713] group-hover:text-white">
                            +
                          </span>
              ...
              <div className="mt-12 hidden justify-end lg:flex">
                ...
                <button
                  ...
                  className="rounded-full bg-[#171713] px-10 py-5 text-sm font-medium text-white transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-30"
                >
                  Continue →
                </button>
          ...
          {step === 2 && (
            <>
              ...
              <div className="max-w-3xl">
                ...
                <h1 className="font-serif text-5xl leading-[0.92] tracking-[-0.055em] sm:text-6xl lg:text-7xl">
                  What feels
                  <br />
                  wrong?
                </h1>

                <p className="mt-6 max-w-lg text-sm leading-6 text-[#777064] sm:text-base">
                  You don't need to know
                  the tailoring terminology.
                  Just tell us what feels
                  wrong.
                </p>
                  ...
                  (garment, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`relative flex min-w-[145px] items-center gap-3 rounded-2xl border p-2 text-left transition ${
                          activeGarmentId ===
                          garment.id
                            ? "border-[#171713] bg-white shadow-sm"
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="mt-1 truncate text-[10px] text-[#8c8478]">
                            {
                              garment.issue ||
                              "Select fit"
                            }
                        ...
                        <span className="absolute bottom-1 left-2 text-[8px] text-[#9b8a70]">
                          0{index + 1}
                        </span>
                      ...
                      {ISSUES.map(
                        (issue) => (
                          <button
                            ...
                            className={`group min-h-[130px] rounded-[22px] border p-4 text-left transition sm:min-h-[155px] sm:p-5 ${
                              activeGarment.issue ===
                              issue.name
              ...
              <div className="mt-10 hidden items-center justify-between gap-3 lg:flex">
                ...
                <button
                  ...
                  className="rounded-full border border-black/10 px-8 py-4 text-sm transition hover:bg-white"
                >
                  ← Back
                </button>
                ...
                <button
                  ...
                  className="rounded-full bg-[#171713] px-10 py-5 text-sm font-medium text-white transition hover:opacity-90"
                >
                  Continue →
                </button>
          ...
          {step === 3 && (
            <>
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-6 max-w-lg text-sm leading-6 text-[#777064] sm:text-base">
                  Give us the basics. We'll
                  call you to confirm your
                  Fit Visit.
                </p>
              ...
              >
                ...
                <button
                  type="submit"
                  className="mt-8 hidden w-full rounded-full bg-[#171713] px-8 py-5 text-sm font-medium text-white transition hover:opacity-90 lg:block"
                >
                  Request my Fit Visit →
                </button>

                <p className="mt-4 hidden text-center text-[11px] text-[#8c8478] lg:block">
          ...
          <div className="sticky top-[77px] flex min-h-[calc(100vh-77px)] flex-col p-9 xl:p-11">
            ...
            {step === 1 && (
              <button
                ...
                className="mt-auto w-full rounded-full bg-[#171713] px-6 py-5 text-sm font-medium text-white transition hover:opacity-90 disabled:opacity-30"
              >
                Continue →
              </button>
            )}
            ...
            {step === 2 && (
              <button
                ...
                className="mt-auto w-full rounded-full bg-[#171713] px-6 py-5 text-sm font-medium text-white transition hover:opacity-90"
              >
                Continue →
              </button>
            )}
      ...
      {step === 3 && (
        <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-black/10 bg-[#f4f0e8]/95 p-3 shadow-[0_-10px_40px_rgba(0,0,0,0.08)] backdrop-blur-xl lg:hidden">
          ...
          <button
            ...
            className="w-full rounded-full bg-[#171713] py-4 text-sm font-medium text-white"
          >
            Request my Fit Visit →
          </button>
...
function SelectedGarment({
  ...
  const image =
    GARMENTS.find(
      (item) =>
        item.type === garment.type
    )?.image;

  return (
    <div className="relative min-w-[155px] overflow-hidden rounded-2xl border border-black/10 bg-white sm:min-w-[180px]">
      ...
      <div className="relative">
        ...
        <div className="absolute left-3 top-3 flex h-7 w-7 items-center justify-center rounded-full bg-white text-[10px] font-semibold shadow">
          {index + 1}
        </div>
              ...
              <>
                ...
                <div className="mt-2 text-[10px] leading-5 text-[#8c8478]">
                  ...
                  2
                    ...
                    : "Add two more garments to reach maximum bundle saving."}
                </div>
              </>
            ) : (
              <>
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-black/10 bg-[#f4f0e8]/95 p-3 shadow-[0_-10px_40px_rgba(0,0,0,0.08)] backdrop-blur-xl lg:hidden">
      ...
      <div className="mx-auto flex max-w-2xl items-center gap-3">
        ...
        <button
          onClick={onClick}
          className="shrink-0 rounded-full bg-[#171713] px-6 py-4 text-xs font-medium text-white"
        >
          {label}
        </button>
